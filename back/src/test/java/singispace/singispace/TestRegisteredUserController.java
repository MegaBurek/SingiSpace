...
import singispace.utils.DbTestUtil;
...
public class TestRegisteredUserController {
	...
	public void setupRegisteredUser() throws ParseException {
		...
		registeredUserService.addRegisteredUser(new RegisteredUser(false,1,"user111","pass111","email111","ime111","prezime111",dt.parse("11-10-2015"),"role1","bio111",null,null,null));
		registeredUserService.addRegisteredUser(new RegisteredUser(false,1,"user222","pass222","email222","ime222","prezime222",dt.parse("10-12-2017"),"role2","bio222",null,null,null));
		registeredUserService.addRegisteredUser(new RegisteredUser(false,1,"user333","pass333","email333","ime333","prezime333",dt.parse("09-03-2011"),"role3","bio333",null,null,null));
    ...
    public void getRegisteredUserId() throws Exception {
        String result = mockMvc.perform(MockMvcRequestBuilders.get("/registeredUser/1").accept(MediaType.APPLICATION_JSON_UTF8))
